 ...
 * 02111-1307, USA
 *
 * Motorola 2007-Jun-21 - Prevent reads and writes from occurring at the same time
 * Motorola 2007-Jun-13 - Remove KEYV shutdown and keep track of resets
 * Motorola 2006-Dec-07 - Add in loop for reading and writing on error return
...
/*! @brief Mutex use to prevent reads and writes from happening at the same time */
