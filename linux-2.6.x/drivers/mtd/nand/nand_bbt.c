...
#if defined(CONFIG_MACH_SCMA11REF) || defined(CONFIG_MACH_ASCENSION) || defined(CONFIG_MACH_LIDO) || defined(CONFIG_MACH_SAIPAN) || defined(CONFIG_MACH_ELBA) || defined(CONFIG_MACH_PICO)
