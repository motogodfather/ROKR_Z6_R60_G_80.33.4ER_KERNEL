...
int atod_ioctl(unsigned int cmd, unsigned long arg)
{
    ...
    switch(cmd)
    {
        ...
        case POWER_IC_IOCTL_ATOD_SET_THERM:
            tracemsg(_k_d("=> Setting Thermistor Pin. "));
...
HACK_retry_conversion:
    ...
    if(channel == POWER_IC_ATOD_CHANNEL_COIN_CELL)
    {
        ...
        if((error = power_ic_atod_set_lithium_coin_cell_en(LICELLCON_ENABLE)) != 0)
        {
            return error;
        }
    }
...
int power_ic_atod_set_lithium_coin_cell_en(int value)
{
    ...
    if(value > 0)
    {
        ...
        if((error = power_ic_set_reg_bit(
                                    ...
                                    LICELLCON_ENABLE)) != 0)
        {
            tracemsg(_k_d("AtoD - Error in enabling the lithium coin cell AtoD reading."));
        }
    }
    else
    {
        ...
        if((error = power_ic_set_reg_bit(
                                    ...
                                    LICELLCON_DISABLE)) != 0)
        {
            tracemsg(_k_d("AtoD - Error in disabling the lithium coin cell AtoD reading."));
        }
    }
