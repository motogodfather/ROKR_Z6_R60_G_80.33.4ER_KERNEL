 ...
 *
 * @note    This function does not turn supply off for SCMA11 reference boards because SDHC needs
 *          to be powered up for detection.
 *
 * @note    This function supports Martinique P3B, Ascension P2 and SCMA11 reference boards P2
 *          and later.  Martinique P3A, ARGON, Ascension P1 and SCMA11 P0/P1 reference boards are
 *          not supported.
 */
int power_ic_set_transflash_voltage(unsigned int millivolts)
{
#if defined(CONFIG_MACH_ASCENSION) || defined(CONFIG_MACH_SCMA11REF) || defined(CONFIG_MACH_LIDO)
    int index = 0;
