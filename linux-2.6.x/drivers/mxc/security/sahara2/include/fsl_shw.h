 ...
 *
 *
 * @section rnd_sec Acquiring Random Numbers
 *
...
#if 1 || defined(SAHARA2) || defined(CONFIG_ARCH_MXC91231)\
    || defined(CONFIG_ARCH_MXC91321) || defined(CONFIG_ARCH_MX27)

#include "sahara.h"

#else
#error FSL_SHW_platform_not_recognized
#endif
 ...
 * resetting the #FSL_SKO_KEY_ESTABLISHED and #FSL_SKO_KEY_USE_UNIQUE_KEY
 * flags.
 *
 ...
 *
 * The #FSL_SKO_KEY_ESTABLISHED will be set (and the #FSL_SKO_KEY_PRESENT and
 * #FSL_SKO_KEY_USE_UNIQUE_KEY flags will be cleared).
 *
 * @param key_object   A variable of type #fsl_shw_sko_t.
