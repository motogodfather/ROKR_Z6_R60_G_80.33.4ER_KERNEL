...
#define SECURE_CLOCK_READ 0x000010
#define SECURE_CLOCK_WRITE 0x000020
...
#define DRM_WRITE (JANUS_DRM_WRITE | SECURE_CLOCK_WRITE | USER_APPS_AUTH_WRITE)

/* DRM_READ is the intersection of all *_READ flags */
#define DRM_READ (JANUS_DRM_READ | SECURE_CLOCK_READ | USER_APPS_AUTH_READ)
...
static const mot_file_perms etc_security_files[] = 
                {
                    { "/etc/pds/security/ivtcounter.dat", (JANUS_DRM_RW | SECURE_CLOCK_RW | USER_APPS_AUTH_RW) },
                    { "/etc/pds/security/ivtcounter.bak", (JANUS_DRM_RW | SECURE_CLOCK_RW | USER_APPS_AUTH_RW) },
                    { "/etc/pds/security/ivtkey.dat", (JANUS_DRM_RW | SECURE_CLOCK_RW | USER_APPS_AUTH_RW) },
                    { "/etc/pds/security/ivtkey.bak", (JANUS_DRM_RW | SECURE_CLOCK_RW | USER_APPS_AUTH_RW) },
                    { "/etc/pds/security/keyring.dat", JANUS_DRM_RW },
                    { "/etc/pds/security/keyring.bak", JANUS_DRM_RW },
                    { "/etc/pds/security/keymaptable.dat", JANUS_DRM_RW },
                    { "/etc/pds/security/keymaptable.bak", JANUS_DRM_RW },
                    ...
                    { "/etc/pds/security/ivt.dat", (JANUS_DRM_RW | SECURE_CLOCK_RW | USER_APPS_AUTH_RW) },
                    { "/etc/pds/security/ivt.bak", (JANUS_DRM_RW | SECURE_CLOCK_RW | USER_APPS_AUTH_RW) },
                    { NULL, 0 }
                };

static const mot_file_perms ezxlocal_tpa_files[] = 
                {
                    { "/ezxlocal/etc/tpa/bctr.dat", (JANUS_DRM_RW | SECURE_CLOCK_RW | USER_APPS_AUTH_RW) },
                    { "/ezxlocal/etc/tpa/ivt.dat", (JANUS_DRM_RW | SECURE_CLOCK_RW | USER_APPS_AUTH_RW) },
                    { "/ezxlocal/etc/tpa/ivt.temp", (JANUS_DRM_RW | SECURE_CLOCK_RW | USER_APPS_AUTH_RW) },
                    { "/ezxlocal/etc/tpa/ivt.lock", (JANUS_DRM_RW | SECURE_CLOCK_RW | USER_APPS_AUTH_RW) },
                    { "/ezxlocal/etc/tpa/keymgr.lock", (JANUS_DRM_RW | USER_APPS_AUTH_RW) },
                    { "/ezxlocal/etc/tpa/tpa.log", (JANUS_DRM_RW | SECURE_CLOCK_RW) },
                    { "/ezxlocal/etc/tpa/persistent", (JANUS_DRM_WRITE | SECURE_CLOCK_WRITE | USER_APPS_AUTH_WRITE) },
                    { "/ezxlocal/etc/tpa/persistent/ivtcounter.lock", (JANUS_DRM_RW | SECURE_CLOCK_RW | USER_APPS_AUTH_RW) },
                    { "/ezxlocal/etc/tpa/persistent/ivtkey.lock", (JANUS_DRM_RW | SECURE_CLOCK_RW | USER_APPS_AUTH_RW) },
                    ...
                    { "/ezxlocal/etc/tpa/persistent/keyring.lock", JANUS_DRM_RW },
                    { "/ezxlocal/etc/tpa/persistent/keymaptable.lock", JANUS_DRM_RW },
                    ...
                    { "/ezxlocal/etc/tpa/persistent/ivt.lock", (JANUS_DRM_RW | SECURE_CLOCK_RW | USER_APPS_AUTH_RW) },
...
static const mot_dir_perms protected_dirs[] = 
                {
                    ...
                    { { "/etc/pds/security", (JANUS_DRM_WRITE | SECURE_CLOCK_WRITE | USER_APPS_AUTH_WRITE) }, etc_security_files },
                    { { "/ezxlocal/etc/tpa", (JANUS_DRM_WRITE | SECURE_CLOCK_WRITE | USER_APPS_AUTH_WRITE) }, ezxlocal_tpa_files },
                    { { NULL, 0 }, NULL }
                };
...
out:
    ...
    if ((bprm->file->f_dentry) && (bprm->file->f_dentry->d_name.name) && (on_rootfs(bprm->file->f_dentry)))
    {
        static const mot_file_perms secure_drm_paths[] = {
            ...
            { "/bin/tcmd", (JANUS_DRM_RW | SECURE_CLOCK_RW) },
