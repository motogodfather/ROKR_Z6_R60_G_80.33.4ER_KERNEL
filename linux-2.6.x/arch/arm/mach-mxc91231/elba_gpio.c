/*
 * linux/arch/arm/mach-mxc91231/elba_gpio.c
 *
...
static struct iomux_initialization atlas_iomux_settings[] __initdata = {
     ...
     * Elba P0 Signal: MMSAP_CLK (Atlas)
     ...
     * Elba P0 Signal: POWER_RDY (Atlas)
     ...
     * Elba P0 Signal: USB_TXEN_B (Atlas)
     ...
     * Elba P0 Signal: USB_VPOUT (Atlas)
     ...
     * Elba P0 Signal: USB_VMOUT (Atlas)
...
static struct iomux_initialization bluetooth_iomux_settings[] __initdata = {
     ...
     * Elba P0 Signal: BT_TX_AP_RX (Bluetooth)
     ...
     * Elba P0 Signal: BT_RTS_B (Bluetooth)
...
static struct iomux_initialization camera_iomux_settings[] __initdata = {
     ...
     * Elba P0 Signal: CSI_MCLK (camera)
     ...
     * Elba P0 Signal: CSI_VSYNC (camera)
     ...
     * Elba P0 Signal: CSI_HSYNC (camera)
     ...
     * Elba P0 Signal: CSI_PIXCLK (camera)
...
static struct iomux_initialization display_iomux_settings[] __initdata = {
     ...
     * Elba P0 Signal: IPU_D0_VSYNC_LD17 (Display)
     ...
     * Elba P0 Signal: IPU_D3_VSYNC (Display)
     ...
     * Elba P0 Signal: IPU_D3_HSYNC (Display)
     ...
     * Elba P0 Signal: IPU_D3_CLK (Display)
     ...
     * Elba P0 Signal: IPU_D3_DRDY (Display)
     ...
     * Elba P0 Signal: IPU_D1CS_LD16 (Display)
     ...
     * Elba P0 Signal: IPU_SD_MISO (Display)
     ...
     * Elba P0 Signal: IPU_SD_CLK (Display)
     ...
     * Elba P0 Signal: IPU_SD_MOSI (Display)
     ...
     * Elba P0 Signal: IPU_LD(0) (Display)
     ...
     * Elba P0 Signal: IPU_LD(1) (Display)
     ...
     * Elba P0 Signal: IPU_LD(2) (Display)
     ...
     * Elba P0 Signal: IPU_LD(3) (Display)
     ...
     * Elba P0 Signal: IPU_LD(4) (Display)
     ...
     * Elba P0 Signal: IPU_LD(5) (Display)
     ...
     * Elba P0 Signal: IPU_LD(6) (Display)
     ...
     * Elba P0 Signal: IPU_LD(7) (Display)
     ...
     * Elba P0 Signal: IPU_LD(8) (Display)
     ...
     * Elba P0 Signal: IPU_LD(9) (Display)
     ...
     * Elba P0 Signal: IPU_LD(10) (Display)
     ...
     * Elba P0 Signal: IPU_LD(11) (Display)
     ...
     * Elba P0 Signal: IPU_LD(12) (Display)
     ...
     * Elba P0 Signal: IPU_LD(13) (Display)
     ...
     * Elba P0 Signal: IPU_LD(14) (Display)
     ...
     * Elba P0 Signal: IPU_LD(15) (Display)
     ...
     * Elba P0 Signal: IPU_SD_D1_CS (Display)
 ...
 */
static struct iomux_initialization fm_iomux_settings[] __initdata = {
    /*
     * SCM-A11 Package Pin Name: GP_AP_C11
     * Elba P0 Signal: FM_INT (FM)
     * Selected Primary Function: GP_AP_C11 (Input)
...
static struct iomux_initialization haptics_iomux_settings[] __initdata = {
     ...
     * Elba P0 Signal: HAPTIC_PULSE (Haptics)
...
static struct iomux_initialization i2c_iomux_settings[] __initdata = {
     ...
     * Elba P0 Signal: I2C_CLK (Camera/USB_HS)
     ...
     * Elba P0 Signal: I2C_DAT (Camera/USB_HS)
...
static struct iomux_initialization keypad_iomux_settings[] __initdata = {
     ...
     * Elba P0 Signal: KPP_ROW(4) (Keypad)
     ...
     * Elba P0 Signal: KPP_COL(3) (Keypad)
     ...
     * Elba P0 Signal: KPP_COL(4) (Keypad)
     ...
     * Elba P0 Signal: KPP_COL(5) (Keypad)
     ...
     * Elba P0 Signal: KPP_ROW(0) (Keypad)
     ...
     * Elba P0 Signal: KPP_ROW(1) (Keypad)
     ...
     * Elba P0 Signal: KPP_ROW(2) (Keypad)
     ...
     * Elba P0 Signal: KPP_ROW(3) (Keypad)
     ...
     * Elba P0 Signal: KPP_COL(0) (Keypad)
     ...
     * Elba P0 Signal: KPP_COL(1) (Keypad)
     ...
     * Elba P0 Signal: KPP_COL(2) (Keypad)
...
static struct iomux_initialization uart3_iomux_settings[] __initdata = {
     ...
     * Elba P0 Signal: GPS_U3_TX (Linux Terminal)
     ...
     * Elba P0 Signal: GPS_U3_RX (Linux Terminal)
...
static struct iomux_initialization usb_hs_iomux_settings[] __initdata = {
    /*
     * SCM-A11 Package Pin Name: GP_AP_B22
     * Elba P0 Signal: USB_HS_DMA_REQ (USB HS)
     * Selected Primary Function: GP_AP_B22 (Input)
     *
 ...
 */
void __init elba_gpio_init(void)
{
    int i, j;
        ...
        unsigned long irq_flags, const char *devname, void *dev_id)
{
    ...
    if(retval == 0) {
        /* only configure signal for interrupts if request_irq was successful */
        gpio_signal_config(GPIO_SIGNAL_USB_HS_DMA_REQ,
                GPIO_GDIR_INPUT, GPIO_INT_HIGH_LEV);
    }
