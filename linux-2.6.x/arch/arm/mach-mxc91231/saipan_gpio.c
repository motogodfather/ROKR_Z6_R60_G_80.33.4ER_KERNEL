/*
 * linux/arch/arm/mach-mxc91231/saipan_gpio.c
 *
...
static struct iomux_initialization atlas_iomux_settings[] __initdata = {
     ...
     * Saipan P1 Signal: ASAP_TX (Atlas)
     ...
     * Saipan P1 Signal: ASAP_RX (Atlas)
     ...
     * Saipan P1 Signal: ASAP_CLK (Atlas)
     ...
     * Saipan P1 Signal: ASAP_FS (Atlas)
     ...
     * Saipan P1 Signal: MMSAP_TX (Atlas)
     ...
     * Saipan P1 Signal: MMSAP_RX (Atlas)
     ...
     * Saipan P1 Signal: MMSAP_CLK (Atlas)
     ...
     * Saipan P1 Signal: MMSAP_FS (Atlas)
     ...
     * Saipan P1 Signal: LOBAT_B (Atlas)
     ...
     * Saipan P1 Signal: POWER_RDY (Atlas)
     ...
     * Saipan P1 Signal: WDOG_AP (Atlas)
     ...
     * Saipan P1 Signal: USB_VPIN (Atlas)
     ...
     * Saipan P1 Signal: USB_VMIN (Atlas)
     ...
     * Saipan P1 Signal: USB_TXEN_B (Atlas)
     ...
     * Saipan P1 Signal: USB_VPOUT (Atlas)
     ...
     * Saipan P1 Signal: USB_VMOUT (Atlas)
     ...
     * Saipan P1 Signal: USB_XRXD (Atlas)
     ...
     * Saipan P1 Signal: VSIM_EN (Atlas)
     ...
     * Saipan P1 Signal: BAT_DETB (Atlas)
...
static struct iomux_initialization bluetooth_iomux_settings[] __initdata = {
     ...
     * Saipan P1 Signal: BT_TX_AP_RX (Bluetooth)
     ...
     * Saipan P1 Signal: BT_RTS_B (Bluetooth)
     ...
     * Saipan P1 Signal: BT_CLK_EN (Bluetooth)
    ...
    /*
     * SCM-A11 Package Pin Name: ED_INT1
     * Saipan P1 Signal: BT_HOST_WAKE_B (Bluetooth)
     * Selected Primary Function: GP_AP_C19 (Input)
     * Selected Secondary Function: ED_INT1 (Input)
     *
...
static struct iomux_initialization camera_iomux_settings[] __initdata = {
     ...
     * Saipan P1 Signal: CSI_D(0) (camera)
     ...
     * Saipan P1 Signal: CSI_D(1) (camera)
     ...
     * Saipan P1 Signal: CSI_D(2) (camera)
     ...
     * Saipan P1 Signal: CSI_D(3) (camera)
     ...
     * Saipan P1 Signal: CSI_D(4) (camera)
     ...
     * Saipan P1 Signal: CSI_D(5) (camera)
     ...
     * Saipan P1 Signal: CSI_D(6) (camera)
     ...
     * Saipan P1 Signal: CSI_D(7) (camera)
     ...
     * Saipan P1 Signal: CSI_MCLK (camera)
     ...
     * Saipan P1 Signal: CSI_VSYNC (camera)
     ...
     * Saipan P1 Signal: CSI_HSYNC (camera)
     ...
     * Saipan P1 Signal: CSI_PIXCLK (camera)
...
static struct iomux_initialization display_iomux_settings[] __initdata = {
     ...
     * Saipan P1 Signal: IPU_D0_VSYNC_LD17 (Display)
     ...
     * Saipan P1 Signal: IPU_D3_VSYNC (Display)
     ...
     * Saipan P1 Signal: IPU_D3_HSYNC (Display)
     ...
     * Saipan P1 Signal: IPU_D3_CLK (Display)
     ...
     * Saipan P1 Signal: IPU_D3_DRDY (Display)
     ...
     * Saipan P1 Signal: IPU_D1CS_LD16 (Display)
    ...
    /*
     * SCM-A11 Package Pin Name: IPU_PAR_RS
     * Saipan P1 Signal: SER_EN (Display)
     * Selected Primary Function: GP_AP_A29 (Output)
     *
     ...
     * Saipan P1 Signal: IPU_SD_MISO (Display)
     ...
     * Saipan P1 Signal: IPU_SD_CLK (Display)
     ...
     * Saipan P1 Signal: IPU_SD_MOSI (Display)
     ...
     * Saipan P1 Signal: IPU_LD(0) (Display)
     ...
     * Saipan P1 Signal: IPU_LD(1) (Display)
     ...
     * Saipan P1 Signal: IPU_LD(2) (Display)
     ...
     * Saipan P1 Signal: IPU_LD(3) (Display)
     ...
     * Saipan P1 Signal: IPU_LD(4) (Display)
     ...
     * Saipan P1 Signal: IPU_LD(5) (Display)
     ...
     * Saipan P1 Signal: IPU_LD(6) (Display)
     ...
     * Saipan P1 Signal: IPU_LD(7) (Display)
     ...
     * Saipan P1 Signal: IPU_LD(8) (Display)
     ...
     * Saipan P1 Signal: IPU_LD(9) (Display)
     ...
     * Saipan P1 Signal: IPU_LD(10) (Display)
     ...
     * Saipan P1 Signal: IPU_LD(11) (Display)
     ...
     * Saipan P1 Signal: IPU_LD(12) (Display)
     ...
     * Saipan P1 Signal: IPU_LD(13) (Display)
     ...
     * Saipan P1 Signal: IPU_LD(14) (Display)
     ...
     * Saipan P1 Signal: IPU_LD(15) (Display)
     ...
     * Saipan P1 Signal: IPU_SD_D1_CS (Display)
...
static struct iomux_initialization haptics_iomux_settings[] __initdata = {
     ...
     * Saipan P1 Signal: SIDE_KEY_HAPTIC (Haptics)
    ...
    /*
     * SCM-A11 Package Pin Name: UH2_SUSPEND
     * Saipan P1 Signal: VIB_AMP_EN (Haptics)
     * Selected Primary Function: GP_SP_A10 (Output)
     *
...
static struct iomux_initialization i2c_iomux_settings[] __initdata = {
     ...
     * Saipan P1 Signal: I2C_CLK (Camera/USB_HS)
     ...
     * Saipan P1 Signal: I2C_DAT (Camera/USB_HS)
...
static struct iomux_initialization keypad_iomux_settings[] __initdata = {
     ...
     * Saipan P1 Signal: KPP_ROW(4) (Keypad)
     ...
     * Saipan P1 Signal: KPP_COL(3) (Keypad)
     ...
     * Saipan P1 Signal: KPP_COL(4) (Keypad)
     ...
     * Saipan P1 Signal: KPP_COL(5) (Keypad)
     ...
     * Saipan P1 Signal: KPP_ROW(0) (Keypad)
     ...
     * Saipan P1 Signal: KPP_ROW(1) (Keypad)
     ...
     * Saipan P1 Signal: KPP_ROW(2) (Keypad)
     ...
     * Saipan P1 Signal: KPP_ROW(3) (Keypad)
     ...
     * Saipan P1 Signal: KPP_COL(0) (Keypad)
     ...
     * Saipan P1 Signal: KPP_COL(1) (Keypad)
     ...
     * Saipan P1 Signal: KPP_COL(2) (Keypad)
...
static struct iomux_initialization misc_iomux_settings[] __initdata = {
     ...
     * Saipan P1 Signal: BATT_DAT (Misc)
...
static struct iomux_initialization mmc_iomux_settings[] __initdata = {
     ...
     * Saipan P1 Signal: SD1_DATA(0) (MMC)
     ...
     * Saipan P1 Signal: SD1_DATA(1) (MMC)
     ...
     * Saipan P1 Signal: SD1_DATA(2) (MMC)
     ...
     * Saipan P1 Signal: SD1_DATA(3) (MMC)
...
static struct iomux_initialization nand_iomux_settings[] __initdata = {
     ...
     * Saipan P1 Signal: NAND_CLE (NAND)
     ...
     * Saipan P1 Signal: NAND_ALE (NAND)
     ...
     * Saipan P1 Signal: NAND_CS_B (NAND)
     ...
     * Saipan P1 Signal: NAND_RE_B (NAND)
     ...
     * Saipan P1 Signal: NAND_WE_B (NAND)
     ...
     * Saipan P1 Signal: NAND_WP_B (NAND)
     ...
     * Saipan P1 Signal: NAND_R_B (NAND)
...
static struct iomux_initialization uart3_iomux_settings[] __initdata = {
     ...
     * Saipan P1 Signal: GPS_U3_TX (Linux Terminal)
     ...
     * Saipan P1 Signal: GPS_U3_RX (Linux Terminal)
 ...
 */
void __init saipan_gpio_init(void)
{
    int i, j;
...
void gpio_lcd_active(void)
{
    ...
    /* Shutdown the LCD before turning on the pixel clock. */
    gpio_signal_set_data(GPIO_SIGNAL_DISP_SD, GPIO_DATA_HIGH);

    /* Delay carried over from Ascension (which has serializer). */
    udelay(50);
