/*
 * linux/arch/arm/mach-mxc91231/ascension_gpio.c
 *
 ...
 */
#ifdef CONFIG_MOT_FEAT_BRDREV
static void gpio_setting_fixup_p1a(void);
#endif /* CONFIG_MOT_FEAT_BRDREV */
...
struct gpio_signal_settings initial_gpio_settings[MAX_GPIO_SIGNAL] = {
     ...
     * Ascension P1 Signal: EL_NUM_EN (Backlight)
     * Ascension P2 Signal: EL_NUM_EN (Backlight)
     * Selected Primary Function: GP_SP_A27 (Output)
     *
     * Array index: 14  GPIO_SIGNAL_EL_NUM_EN
     */
     ...
     *
     * Array index: 15  GPIO_SIGNAL_EL_NAV_EN
     */
...
static struct iomux_initialization atlas_iomux_settings[] __initdata = {
     ...
     * Ascension P1 Signal: ASAP_TX (Atlas)
     * Ascension P2 Signal: ASAP_TX (Atlas)
     ...
     * Ascension P1 Signal: ASAP_RX (Atlas)
     * Ascension P2 Signal: ASAP_RX (Atlas)
     ...
     * Ascension P1 Signal: ASAP_CLK (Atlas)
     * Ascension P2 Signal: ASAP_CLK (Atlas)
     ...
     * Ascension P1 Signal: ASAP_FS (Atlas)
     * Ascension P2 Signal: ASAP_FS (Atlas)
     ...
     * Ascension P1 Signal: MMSAP_TX (Atlas)
     * Ascension P2 Signal: MMSAP_TX (Atlas)
     ...
     * Ascension P1 Signal: MMSAP_RX (Atlas)
     * Ascension P2 Signal: MMSAP_RX (Atlas)
     ...
     * Ascension P1 Signal: MMSAP_CLK (Atlas)
     * Ascension P2 Signal: MMSAP_CLK (Atlas)
     ...
     * Ascension P1 Signal: MMSAP_FS (Atlas)
     * Ascension P2 Signal: MMSAP_FS (Atlas)
     ...
     * Ascension P1 Signal: LOBAT_B (Atlas)
     * Ascension P2 Signal: LOBAT_B (Atlas)
     ...
     * Ascension P1 Signal: POWER_RDY (Atlas)
     * Ascension P2 Signal: POWER_RDY (Atlas)
     ...
     * Ascension P1 Signal: WDOG_AP (Atlas)
     * Ascension P2 Signal: WDOG_AP (Atlas)
     ...
     * Ascension P1 Signal: USB_VPIN (Atlas)
     * Ascension P2 Signal: USB_VPIN (Atlas)
     ...
     * Ascension P1 Signal: USB_VMIN (Atlas)
     * Ascension P2 Signal: USB_VMIN (Atlas)
     ...
     * Ascension P1 Signal: PM_INT (Atlas)
     * Ascension P2 Signal: PM_INT (Atlas)
     ...
     * Ascension P1 Signal: USB_TXEN_B (Atlas)
     * Ascension P2 Signal: USB_TXEN_B (Atlas)
     ...
     * Ascension P1 Signal: USB_VPOUT (Atlas)
     * Ascension P2 Signal: USB_VPOUT (Atlas)
     ...
     * Ascension P1 Signal: USB_VMOUT (Atlas)
     * Ascension P2 Signal: USB_VMOUT (Atlas)
     ...
     * Ascension P1 Signal: USB_XRXD (Atlas)
     * Ascension P2 Signal: USB_XRXD (Atlas)
     ...
     * Ascension P1 Signal: VSIM_EN (Atlas)
     * Ascension P2 Signal: VSIM_EN (Atlas)
     ...
     * Ascension P1 Signal: BAT_DETB (Atlas)
     * Ascension P2 Signal: BAT_DETB (Atlas)
...
static struct iomux_initialization bluetooth_iomux_settings[] __initdata = {
     ...
     * Ascension P1 Signal: BT_TX_AP_RX (Bluetooth)
     * Ascension P2 Signal: BT_TX_AP_RX (Bluetooth)
     ...
     * Ascension P1 Signal: BT_RTS_B (Bluetooth)
     * Ascension P2 Signal: BT_RTS_B (Bluetooth)
     ...
     * Ascension P1 Signal: BT_CLK_EN (Bluetooth)
     * Ascension P2 Signal: BT_CLK_EN (Bluetooth)
...
static struct iomux_initialization camera_iomux_settings[] __initdata = {
     ...
     * Ascension P1 Signal: CSI_D(0) (camera)
     * Ascension P2 Signal: CSI_D(0) (camera)
     ...
     * Ascension P1 Signal: CSI_D(1) (camera)
     * Ascension P2 Signal: CSI_D(1) (camera)
     ...
     * Ascension P1 Signal: CSI_D(2) (camera)
     * Ascension P2 Signal: CSI_D(2) (camera)
     ...
     * Ascension P1 Signal: CSI_D(3) (camera)
     * Ascension P2 Signal: CSI_D(3) (camera)
     ...
     * Ascension P1 Signal: CSI_D(4) (camera)
     * Ascension P2 Signal: CSI_D(4) (camera)
     ...
     * Ascension P1 Signal: CSI_D(5) (camera)
     * Ascension P2 Signal: CSI_D(5) (camera)
     ...
     * Ascension P1 Signal: CSI_D(6) (camera)
     * Ascension P2 Signal: CSI_D(6) (camera)
     ...
     * Ascension P1 Signal: CSI_D(7) (camera)
     * Ascension P2 Signal: CSI_D(7) (camera)
     ...
     * Ascension P1 Signal: CSI_MCLK (camera)
     * Ascension P2 Signal: CSI_MCLK (camera)
     ...
     * Ascension P1 Signal: CSI_VSYNC (camera)
     * Ascension P2 Signal: CSI_VSYNC (camera)
     ...
     * Ascension P1 Signal: CSI_HSYNC (camera)
     * Ascension P2 Signal: CSI_HSYNC (camera)
     ...
     * Ascension P1 Signal: CSI_PIXCLK (camera)
     * Ascension P2 Signal: CSI_PIXCLK (camera)
...
static struct iomux_initialization display_iomux_settings[] __initdata = {
     ...
     * Ascension P1 Signal: IPU_D0_VSYNC_LD17 (Display)
     * Ascension P2 Signal: IPU_D0_VSYNC_LD17 (Display)
     ...
     * Ascension P1 Signal: IPU_D3_VSYNC (Display)
     * Ascension P2 Signal: IPU_D3_VSYNC (Display)
     ...
     * Ascension P1 Signal: IPU_D3_HSYNC (Display)
     * Ascension P2 Signal: IPU_D3_HSYNC (Display)
     ...
     * Ascension P1 Signal: IPU_D3_CLK (Display)
     * Ascension P2 Signal: IPU_D3_CLK (Display)
     ...
     * Ascension P1 Signal: IPU_D3_DRDY (Display)
     * Ascension P2 Signal: IPU_D3_DRDY (Display)
     ...
     * Ascension P1 Signal: IPU_D1CS_LD16 (Display)
     * Ascension P2 Signal: IPU_D1CS_LD16 (Display)
     ...
     * Ascension P1 Signal: IPU_SD_MISO (Display)
     * Ascension P2 Signal: IPU_SD_MISO (Display)
     ...
     * Ascension P1 Signal: IPU_SD_CLK (Display)
     * Ascension P2 Signal: IPU_SD_CLK (Display)
     ...
     * Ascension P1 Signal: IPU_SD_MOSI (Display)
     * Ascension P2 Signal: IPU_SD_MOSI (Display)
     ...
     * Ascension P1 Signal: IPU_LD(0) (Display)
     * Ascension P2 Signal: IPU_LD(0) (Display)
     ...
     * Ascension P1 Signal: IPU_LD(1) (Display)
     * Ascension P2 Signal: IPU_LD(1) (Display)
     ...
     * Ascension P1 Signal: IPU_LD(2) (Display)
     * Ascension P2 Signal: IPU_LD(2) (Display)
     ...
     * Ascension P1 Signal: IPU_LD(3) (Display)
     * Ascension P2 Signal: IPU_LD(3) (Display)
     ...
     * Ascension P1 Signal: IPU_LD(4) (Display)
     * Ascension P2 Signal: IPU_LD(4) (Display)
     ...
     * Ascension P1 Signal: IPU_LD(5) (Display)
     * Ascension P2 Signal: IPU_LD(5) (Display)
     ...
     * Ascension P1 Signal: IPU_LD(6) (Display)
     * Ascension P2 Signal: IPU_LD(6) (Display)
     ...
     * Ascension P1 Signal: IPU_LD(7) (Display)
     * Ascension P2 Signal: IPU_LD(7) (Display)
     ...
     * Ascension P1 Signal: IPU_LD(8) (Display)
     * Ascension P2 Signal: IPU_LD(8) (Display)
     ...
     * Ascension P1 Signal: IPU_LD(9) (Display)
     * Ascension P2 Signal: IPU_LD(9) (Display)
     ...
     * Ascension P1 Signal: IPU_LD(10) (Display)
     * Ascension P2 Signal: IPU_LD(10) (Display)
     ...
     * Ascension P1 Signal: IPU_LD(11) (Display)
     * Ascension P2 Signal: IPU_LD(11) (Display)
     ...
     * Ascension P1 Signal: IPU_LD(12) (Display)
     * Ascension P2 Signal: IPU_LD(12) (Display)
     ...
     * Ascension P1 Signal: IPU_LD(13) (Display)
     * Ascension P2 Signal: IPU_LD(13) (Display)
     ...
     * Ascension P1 Signal: IPU_LD(14) (Display)
     * Ascension P2 Signal: IPU_LD(14) (Display)
     ...
     * Ascension P1 Signal: IPU_LD(15) (Display)
     * Ascension P2 Signal: IPU_LD(15) (Display)
     ...
     * Ascension P1 Signal: IPU_SD_D1_CS (Display)
     * Ascension P2 Signal: IPU_SD_D1_CS (Display)
...
static struct iomux_initialization i2c_iomux_settings[] __initdata = {
     ...
     * Ascension P1 Signal: I2C_CLK (camera)
     * Ascension P2 Signal: I2C_CLK (Camera/USB_HS)
     ...
     * Ascension P1 Signal: I2C_DAT (camera)
     * Ascension P2 Signal: I2C_DAT (Camera/USB_HS)
...
static struct iomux_initialization keypad_iomux_settings[] __initdata = {
     ...
     * Ascension P1 Signal: KPP_ROW(4) (Keypad)
     * Ascension P2 Signal: KPP_ROW(4) (Keypad)
     ...
     * Ascension P1 Signal: KPP_COL(3) (Keypad)
     * Ascension P2 Signal: KPP_COL(3) (Keypad)
     ...
     * Ascension P1 Signal: KPP_COL(4) (Keypad)
     * Ascension P2 Signal: KPP_COL(4) (Keypad)
     ...
     * Ascension P1 Signal: KPP_COL(5) (Keypad)
     * Ascension P2 Signal: KPP_COL(5) (Keypad)
     ...
     * Ascension P1 Signal: KPP_ROW(0) (Keypad)
     * Ascension P2 Signal: KPP_ROW(0) (Keypad)
     ...
     * Ascension P1 Signal: KPP_ROW(1) (Keypad)
     * Ascension P2 Signal: KPP_ROW(1) (Keypad)
     ...
     * Ascension P1 Signal: KPP_ROW(2) (Keypad)
     * Ascension P2 Signal: KPP_ROW(2) (Keypad)
     ...
     * Ascension P1 Signal: KPP_ROW(3) (Keypad)
     * Ascension P2 Signal: KPP_ROW(3) (Keypad)
     ...
     * Ascension P1 Signal: KPP_COL(0) (Keypad)
     * Ascension P2 Signal: KPP_COL(0) (Keypad)
     ...
     * Ascension P1 Signal: KPP_COL(1) (Keypad)
     * Ascension P2 Signal: KPP_COL(1) (Keypad)
     ...
     * Ascension P1 Signal: KPP_COL(2) (Keypad)
     * Ascension P2 Signal: KPP_COL(2) (Keypad)
...
static struct iomux_initialization misc_iomux_settings[] __initdata = {
     ...
     * Ascension P1 Signal: BATT_DAT (Misc)
     * Ascension P2 Signal: BATT_DAT (Misc)
     ...
     * Ascension P1 Signal: WDOG_BP (Misc)
     * Ascension P2 Signal: WDOG_BP (Misc)
     ...
     * Ascension P1 Signal: DAI_TX (Misc)
     * Ascension P2 Signal: DAI_TX (Misc)
     ...
     * Ascension P1 Signal: DAI_CLK (Misc)
     * Ascension P2 Signal: DAI_CLK (Misc)
     ...
     * Ascension P1 Signal: DAI_FS (Misc)
     * Ascension P2 Signal: DAI_FS (Misc)
     ...
     * Ascension P1 Signal: DAI_RX (Misc)
     * Ascension P2 Signal: DAI_RX (Misc)
...
static struct iomux_initialization mmc_iomux_settings[] __initdata = {
     ...
     * Ascension P1 Signal: TF_DET (MMC)
     ...
     * Ascension P1 Signal: SD1_DATA(0) (MMC)
     * Ascension P2 Signal: SD1_DATA(0) (MMC)
     ...
     * Ascension P1 Signal: SD1_DATA(1) (MMC)
     * Ascension P2 Signal: SD1_DATA(1) (MMC)
     ...
     * Ascension P1 Signal: SD1_DATA(2) (MMC)
     * Ascension P2 Signal: SD1_DATA(2) (MMC)
     ...
     * Ascension P1 Signal: SD1_DATA(3) (MMC)
     * Ascension P2 Signal: SD1_DATA(3) (MMC)
     ...
     * Ascension P1 Signal: SD1_CMD (MMC)
     * Ascension P2 Signal: SD1_CMD (MMC)
     ...
     * Ascension P1 Signal: SD1_CLK (MMC)
     * Ascension P2 Signal: SD1_CLK (MMC)
...
static struct iomux_initialization nand_iomux_settings[] __initdata = {
     ...
     * Ascension P1 Signal: NAND_CLE (NAND)
     * Ascension P2 Signal: NAND_CLE (NAND)
     ...
     * Ascension P1 Signal: NAND_ALE (NAND)
     * Ascension P2 Signal: NAND_ALE (NAND)
     ...
     * Ascension P1 Signal: NAND_CS_B (NAND)
     * Ascension P2 Signal: NAND_CS_B (NAND)
     ...
     * Ascension P1 Signal: NAND_RE_B (NAND)
     * Ascension P2 Signal: NAND_RE_B (NAND)
     ...
     * Ascension P1 Signal: NAND_WE_B (NAND)
     * Ascension P2 Signal: NAND_WE_B (NAND)
     ...
     * Ascension P1 Signal: NAND_WP_B (NAND)
     * Ascension P2 Signal: NAND_WP_B (NAND)
     ...
     * Ascension P1 Signal: NAND_R_B (NAND)
     * Ascension P2 Signal: NAND_R_B (NAND)
...
static struct iomux_initialization sim_iomux_settings[] __initdata = {
     ...
     * Ascension P1 Signal: SIM_RST (SIM)
     * Ascension P2 Signal: SIM_RST (SIM)
     ...
     * Ascension P1 Signal: SIM_CLK (SIM)
     * Ascension P2 Signal: SIM_CLK (SIM)
     ...
     * Ascension P1 Signal: SIM_IO (SIM)
     * Ascension P2 Signal: SIM_IO (SIM)
...
static struct iomux_initialization uart3_iomux_settings[] __initdata = {
     ...
     * Ascension P1 Signal: GPS_U3_TX (Linux Terminal)
     * Ascension P2 Signal: GPS_U3_TX (Linux Terminal)
     ...
     * Ascension P1 Signal: GPS_U3_RX (Linux Terminal)
     * Ascension P2 Signal: GPS_U3_RX (Linux Terminal)
...
static struct iomux_initialization usb_hs_iomux_settings[] __initdata = {
     ...
     * SCM-A11 Package Pin Name: GP_AP_B22
     * Ascension P1 Signal: NC (NC)
     * Ascension P2 Signal: USB_HS_DMA_REQ (USB HS)
     * Selected Primary Function: GP_AP_B22 (Input)
     *
 ...
 */
void __init ascension_gpio_init(void)
{
    int i, j;
 ...
 * 
 * For P1:  Pin: UH2_SUSPEND    GPIO: GP_SP_A10
 * For P2:  Pin: UH2_RXDM       GPIO: GP_SP_A13
 *
