...
#define phone_gpio_init         scma11ref_gpio_init
#elif defined(CONFIG_MACH_ASCENSION)
#define phone_gpio_init         ascension_gpio_init
#elif defined(CONFIG_MACH_SAIPAN)
#define phone_gpio_init         saipan_gpio_init
#elif defined(CONFIG_MACH_LIDO)
#define phone_gpio_init         lido_gpio_init
#elif defined(CONFIG_MACH_ELBA)
#define phone_gpio_init         elba_gpio_init
#elif defined(CONFIG_MACH_PICO)
#define phone_gpio_init         pico_gpio_init
#endif
...
extern void phone_gpio_init(void) __init;
 ...
 * initialize __mach_desc_PHONE data structure.
 */
#if defined(CONFIG_MACH_SCMA11REF)

MACHINE_START(SCMA11REF, "Motorola SCM-A11 Reference Platform")
...
MACHINE_START(ASCENSION, "Motorola Product - Ascension")
        MAINTAINER("Motorola, Inc.")
        /*       physical memory    physical IO        virtual IO     */
        BOOT_MEM(PHYS_OFFSET_ASM, AIPS1_BASE_ADDR, AIPS1_BASE_ADDR_VIRT)
	BOOT_PARAMS(PHYS_OFFSET_ASM + 0x100)
...
MACHINE_START(SAIPAN, "Motorola Product - Saipan")
        MAINTAINER("Motorola, Inc.")
        /*       physical memory    physical IO        virtual IO     */
        BOOT_MEM(PHYS_OFFSET_ASM, AIPS1_BASE_ADDR, AIPS1_BASE_ADDR_VIRT)
	BOOT_PARAMS(PHYS_OFFSET_ASM + 0x100)
...
/* end CONFIG_MACH_LIDO */
#elif defined(CONFIG_MACH_LIDO)

MACHINE_START(LIDO, "Motorola Product - Lido")
        MAINTAINER("Motorola, Inc.")
        /*       physical memory    physical IO        virtual IO     */
        BOOT_MEM(PHYS_OFFSET_ASM, AIPS1_BASE_ADDR, AIPS1_BASE_ADDR_VIRT)
	BOOT_PARAMS(PHYS_OFFSET_ASM + 0x100)
...
MACHINE_START(ELBA, "Motorola Product - Elba")
        MAINTAINER("Motorola, Inc.")
        /*       physical memory    physical IO        virtual IO     */
        BOOT_MEM(PHYS_OFFSET_ASM, AIPS1_BASE_ADDR, AIPS1_BASE_ADDR_VIRT)
	BOOT_PARAMS(PHYS_OFFSET_ASM + 0x100)
...
/* end CONFIG_MACH_ELBA */
#elif defined(CONFIG_MACH_PICO)

MACHINE_START(ELBA, "Motorola Product - Pico")
        MAINTAINER("Motorola, Inc.")
        /*       physical memory    physical IO        virtual IO     */
        BOOT_MEM(PHYS_OFFSET_ASM, AIPS1_BASE_ADDR, AIPS1_BASE_ADDR_VIRT)
	BOOT_PARAMS(PHYS_OFFSET_ASM + 0x100)
