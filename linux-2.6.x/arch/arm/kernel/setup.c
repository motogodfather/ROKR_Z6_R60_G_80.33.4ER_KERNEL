...
{
        mot_set_flat_dev_tree_address(tag->u.flat_dev_tree_address.flat_dev_tree_address);
        printk(KERN_INFO "%s: flat_dev_tree_address=0x%08x\n",
				__FUNCTION__, mot_flat_dev_tree_address());
	return 0;
}
...
{
        mot_set_logo_version((u8 *)tag->u.logo_version.logo_version);
