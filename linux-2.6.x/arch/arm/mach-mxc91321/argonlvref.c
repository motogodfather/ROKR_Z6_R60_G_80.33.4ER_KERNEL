/*
 * linux/arch/arm/mach-mxc91321/argonlvref.c
 *
...
extern void argonlvref_gpio_init(void) __init;
 ...
 * initialize __mach_desc_ARGONLVREF data structure.
 */
MACHINE_START(ARGONLVREF, "Motorola ArgonLV Reference Platform")
