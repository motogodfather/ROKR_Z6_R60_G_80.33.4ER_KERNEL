 ...
 * Date         Author          Comment
 * ===========  ==============  ==============================================
 * 26-Aug-2005  Motorola        Overwrote the generic sched_clock function to
 ...
 * 27-Jun-2006  Motorola        Renamed sched_clock funtion to get_curr_ns_time
...
unsigned long long get_curr_ns_time(void) {
	return os_timer_initialized ? (((unsigned long long)(*_reg_GPT_GPTCNT)) * (NSEC_PER_SEC/CLOCK_TICK_RATE)) : 0;
}
